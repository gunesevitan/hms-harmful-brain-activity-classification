...
if __name__ == '__main__':
    ...
    if args.mode == 'training':
        ...
        for fold in config['training']['folds']:
            ...
            training_eeg_paths, training_targets, training_target_classes, training_sample_qualities = torch_datasets.prepare_data(
                df.loc[training_idx],
            ...
            training_dataset = torch_datasets.EEGDataset(
                eeg_paths=training_eeg_paths,
            ...
            validation_dataset = torch_datasets.EEGDataset(
                eeg_paths=validation_eeg_paths,
