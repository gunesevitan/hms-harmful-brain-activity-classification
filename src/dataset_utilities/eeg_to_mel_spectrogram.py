...
if __name__ == '__main__':
    ...
    dataset_directory = settings.DATA / 'eeg_spectrograms-mel-50-second2'
        ...
        for _, row in df_train_eeg.iterrows():
            ...
            for signal_idx in range(eeg.shape[1]):
                ...
                if center_stack:
                    ...
                    # Center 10 second spectrogram with higher time resolution is created
                    spectrogram_center = librosa.feature.melspectrogram(
                        y=eeg[:, signal_idx],
                        sr=200,
                        hop_length=20,
                        n_fft=200,
                    ...
                    spectrograms.append(spectrogram_center.astype(np.float32))
